class Manuscript < ActiveFedora::Base
  ...
  property :description, predicate: ::RDF::URI.new('http://library.upenn.edu/pqc/ns/description'), multiple: true do |index|
    index.as :stored_searchable, :facetable
  end

  property :language, predicate: ::RDF::URI.new('http://library.upenn.edu/pqc/ns/language'), multiple: true do |index|
    index.as :stored_searchable, :facetable
  end
