    ...
    context 'with iiif assets' do
      ...
      it 'document contains expected fields' do
        expect(item.solr_document).to include(
          ...
          creator_tesim: ['creator, random'],
          creator_ssim: ['creator, random'],
          contributor_tesim: ['contributor, random'],
          contributor_ssim: ['contributor, random'],
          name_tesim: ['random, person', 'second random, person'],
          name_ssim: ['random, person', 'second random, person'],
          name_with_role_ssim: ['random, person', 'second random, person (illustrator)'],
          name_with_role_tesim: ['random, person', 'second random, person (illustrator)'],
