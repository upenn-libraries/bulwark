...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    # facet bar
    config.add_facet_field solr_name('administrative_contact', :facetable), :label => 'Administrative Contact'
    config.add_facet_field solr_name('administrative_contact_email', :facetable), :label => 'Administrative Contact Email'
    config.add_facet_field solr_name('metadata_creator', :facetable), :label => 'Metadata Creator'
    config.add_facet_field solr_name('metadata_creator_email', :facetable), :label => 'Metadata Creator Email'
    config.add_facet_field solr_name('repository_country', :facetable), :label => 'Repository Country'
    config.add_facet_field solr_name('repository_city', :facetable), :label => 'Repository City'
    ...
    config.add_facet_field solr_name('call_number_id', :facetable), :label => 'Call Number ID'
    config.add_facet_field solr_name('record_url', :facetable), :label => 'Record URL'
    config.add_facet_field solr_name('alternate_id', :facetable), :label => 'Alternate ID'
    config.add_facet_field solr_name('alternate_id_type', :facetable), :label => 'Alternate ID Type'
    config.add_facet_field solr_name('manuscript_name', :facetable), :label => 'Manuscript Name'
    config.add_facet_field solr_name('author_name', :facetable), :label => 'Author Name'
    config.add_facet_field solr_name('author_uri', :facetable), :label => 'Author URI'
    config.add_facet_field solr_name('translator_name', :facetable), :label => 'Translator Name'
    config.add_facet_field solr_name('translator_uri', :facetable), :label => 'Translator URI'
    config.add_facet_field solr_name('artist_name', :facetable), :label => 'Artist Name'
    config.add_facet_field solr_name('artist_uri', :facetable), :label => 'Artist URI'
    config.add_facet_field solr_name('former_owner_name', :facetable), :label => 'Former Owner Name'
    config.add_facet_field solr_name('former_owner_uri', :facetable), :label => 'Former Owner URI'
    config.add_facet_field solr_name('provenance', :facetable), :label => 'Provenance'
    config.add_facet_field solr_name('date_single', :facetable), :label => 'Date Single'
    config.add_facet_field solr_name('date_range_start', :facetable), :label => 'Date Range Start'
    config.add_facet_field solr_name('date_range_end', :facetable), :label => 'Date Range End'
    ...
    config.add_facet_field solr_name('foliation_pagination', :facetable), :label => 'Foliation/Pagination'
    config.add_facet_field solr_name('flyleaves_and_leaves', :facetable), :label => 'Flyleaves &amp; Leaves'
    config.add_facet_field solr_name('layout', :facetable), :label => 'Layout'
    config.add_facet_field solr_name('colophon', :facetable), :label => 'Colophon'
    config.add_facet_field solr_name('collation', :facetable), :label => 'Collation'
    config.add_facet_field solr_name('script', :facetable), :label => 'Script'
    config.add_facet_field solr_name('decoration', :facetable), :label => 'Decoration'
    config.add_facet_field solr_name('binding', :facetable), :label => 'Binding'
    config.add_facet_field solr_name('watermarks', :facetable), :label => 'Watermarks'
    config.add_facet_field solr_name('catchwords', :facetable), :label => 'Catchwords'
    config.add_facet_field solr_name('signatures', :facetable), :label => 'Signatures'
    config.add_facet_field solr_name('notes', :facetable), :label => 'Notes'
    config.add_facet_field solr_name('support_material', :facetable), :label => 'Support Material'
    config.add_facet_field solr_name('page_dimensions', :facetable), :label => 'Page Dimensions'
    config.add_facet_field solr_name('bound_dimensions', :facetable), :label => 'Bound Dimensions'
    config.add_facet_field solr_name('related_resource', :facetable), :label => 'Related Resource'
    config.add_facet_field solr_name('related_resource_url', :facetable), :label => 'Related Resource URL'
    config.add_facet_field solr_name('subject_names', :facetable), :label => 'Subject Names'
    config.add_facet_field solr_name('subject_names_uri', :facetable), :label => 'Subject Names URI'
    config.add_facet_field solr_name('subject_topical', :facetable), :label => 'Subject Topical'
    config.add_facet_field solr_name('subject_topical_uri', :facetable), :label => 'Subject Topical URI'
    config.add_facet_field solr_name('subject_geographic', :facetable), :label => 'Subject Geographic'
    config.add_facet_field solr_name('subject_geographic_uri', :facetable), :label => 'Subject Geographic URI'
    config.add_facet_field solr_name('subject_genre_form', :facetable), :label => 'Subject Genre/Form'
    config.add_facet_field solr_name('subject_genre_form_uri', :facetable), :label => 'Subject Genre/Form URI'
    ...
    config.add_index_field solr_name('administrative_contact_email', :stored_searchable, type: :string), :label => 'Administrative Contact Email'
    config.add_index_field solr_name('metadata_creator', :stored_searchable, type: :string), :label => 'Metadata Creator'
    config.add_index_field solr_name('metadata_creator_email', :stored_searchable, type: :string), :label => 'Metadata Creator Email'
    config.add_index_field solr_name('repository_country', :stored_searchable, type: :string), :label => 'Repository Country'
    config.add_index_field solr_name('repository_city', :stored_searchable, type: :string), :label => 'Repository City'
    ...
    config.add_index_field solr_name('author_name', :stored_searchable, type: :string), :label => 'Author Name'
    config.add_index_field solr_name('author_uri', :stored_searchable, type: :string), :label => 'Author URI'
    config.add_index_field solr_name('translator_name', :stored_searchable, type: :string), :label => 'Translator Name'
    config.add_index_field solr_name('translator_uri', :stored_searchable, type: :string), :label => 'Translator URI'
    config.add_index_field solr_name('artist_name', :stored_searchable, type: :string), :label => 'Artist Name'
    config.add_index_field solr_name('artist_uri', :stored_searchable, type: :string), :label => 'Artist URI'
    config.add_index_field solr_name('former_owner_name', :stored_searchable, type: :string), :label => 'Former Owner Name'
    config.add_index_field solr_name('former_owner_uri', :stored_searchable, type: :string), :label => 'Former Owner URI'
    config.add_index_field solr_name('provenance', :stored_searchable, type: :string), :label => 'Provenance'
    ...
    config.add_index_field solr_name('foliation_pagination', :stored_searchable, type: :string), :label => 'Foliation/Pagination'
    config.add_index_field solr_name('flyleaves_and_leaves', :stored_searchable, type: :string), :label => 'Flyleaves &amp; Leaves'
    config.add_index_field solr_name('layout', :stored_searchable, type: :string), :label => 'Layout'
    config.add_index_field solr_name('colophon', :stored_searchable, type: :string), :label => 'Colophon'
    config.add_index_field solr_name('collation', :stored_searchable, type: :string), :label => 'Collation'
    config.add_index_field solr_name('script', :stored_searchable, type: :string), :label => 'Script'
    config.add_index_field solr_name('decoration', :stored_searchable, type: :string), :label => 'Decoration'
    config.add_index_field solr_name('binding', :stored_searchable, type: :string), :label => 'Binding'
    config.add_index_field solr_name('watermarks', :stored_searchable, type: :string), :label => 'Watermarks'
    config.add_index_field solr_name('catchwords', :stored_searchable, type: :string), :label => 'Catchwords'
    config.add_index_field solr_name('signatures', :stored_searchable, type: :string), :label => 'Signatures'
    ...
    config.add_index_field solr_name('related_resource', :stored_searchable, type: :string), :label => 'Related Resource'
    config.add_index_field solr_name('related_resource_url', :stored_searchable, type: :string), :label => 'Related Resource URL'
    config.add_index_field solr_name('subject_names', :stored_searchable, type: :string), :label => 'Subject Names'
    config.add_index_field solr_name('subject_names_uri', :stored_searchable, type: :string), :label => 'Subject Names URI'
    config.add_index_field solr_name('subject_topical', :stored_searchable, type: :string), :label => 'Subject Topical'
    config.add_index_field solr_name('subject_topical_uri', :stored_searchable, type: :string), :label => 'Subject Topical URI'
    config.add_index_field solr_name('subject_geographic', :stored_searchable, type: :string), :label => 'Subject Geographic'
    config.add_index_field solr_name('subject_geographic_uri', :stored_searchable, type: :string), :label => 'Subject Geographic URI'
    config.add_index_field solr_name('subject_genre_form', :stored_searchable, type: :string), :label => 'Subject Genre/Form'
    config.add_index_field solr_name('subject_genre_form_uri', :stored_searchable, type: :string), :label => 'Subject Genre/Form URI'
