    ...
    <xsl:template match="/root/record">
      <xsl:copy>
        <exsl:document method="xml" href="{uuid}.xml">
          ...
          <sv:property sv:name="ns004:administrative_contact" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="administrative_contact" />
          </sv:property>

          <sv:property sv:name="ns004:administrative_contact_email" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="administrative_contact_email" />
          </sv:property>

          <sv:property sv:name="ns004:metadata_creator" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="metadata_creator" />
          </sv:property>

          <sv:property sv:name="ns004:metadata_creator_email" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="metadata_creator_email" />
          </sv:property>

          <sv:property sv:name="ns004:repository_country" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="repository_country" />
          </sv:property>

          <sv:property sv:name="ns004:repository_city" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="repository_city" />
          </sv:property>

          <sv:property sv:name="ns004:holding_institution" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="holding_institution" />
          </sv:property>

          <sv:property sv:name="ns004:repository_name" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="repository_name" />
          </sv:property>

          <sv:property sv:name="ns004:source_collection" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="source_collection" />
          </sv:property>

          <sv:property sv:name="ns004:call_number_id" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="call_number_id" />
          </sv:property>

          <sv:property sv:name="ns004:record_url" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="record_url" />
          </sv:property>

          <sv:property sv:name="ns004:alternate_id" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="alternate_id" />
          </sv:property>

          <sv:property sv:name="ns004:alternate_id_type" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="alternate_id_type" />
          </sv:property>

          <sv:property sv:name="ns004:manuscript_name" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="manuscript_name" />
          </sv:property>

          <sv:property sv:name="ns004:author_name" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="author_name" />
          </sv:property>

          <sv:property sv:name="ns004:author_uri" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="author_uri" />
          </sv:property>

          <sv:property sv:name="ns004:translator_name" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="translator_name" />
          </sv:property>

          <sv:property sv:name="ns004:translator_uri" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="translator_uri" />
          </sv:property>

          <sv:property sv:name="ns004:artist_name" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="artist_name" />
          </sv:property>

          <sv:property sv:name="ns004:artist_uri" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="artist_uri" />
          </sv:property>

          <sv:property sv:name="ns004:former_owner_name" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="former_owner_name" />
          </sv:property>

          <sv:property sv:name="ns004:former_owner_uri" sv:type="String" sv:multiple="false">
          ...
          <sv:property sv:name="ns004:date_single" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="date_single" />
          </sv:property>

          <sv:property sv:name="ns004:date_range_start" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="date_range_start" />
          </sv:property>

          <sv:property sv:name="ns004:date_range_end" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="date_range_end" />
          </sv:property>

          <sv:property sv:name="ns004:date_narrative" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="date_narrative" />
          </sv:property>

          <sv:property sv:name="ns004:place_of_origin" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="place_of_origin" />
          </sv:property>

          <sv:property sv:name="ns004:origin_details" sv:type="String" sv:multiple="false">
          ...
          <sv:property sv:name="ns004:foliation_pagination" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="foliation_pagination" />
          </sv:property>

          <sv:property sv:name="ns004:flyleaves_and_leaves" sv:type="String" sv:multiple="false">
          ...
          <sv:property sv:name="ns004:support_material" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="support_material" />
          </sv:property>

          <sv:property sv:name="ns004:page_dimensions" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="page_dimensions" />
          </sv:property>

          <sv:property sv:name="ns004:bound_dimensions" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="bound_dimensions" />
          </sv:property>

          <sv:property sv:name="ns004:related_resource" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="related_resource" />
          </sv:property>

          <sv:property sv:name="ns004:related_resource_url" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="related_resource_url" />
          </sv:property>

          <sv:property sv:name="ns004:subject_names" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="subject_names" />
          </sv:property>

          <sv:property sv:name="ns004:subject_names_uri" sv:type="String" sv:multiple="false">
          ...
          <sv:property sv:name="ns004:subject_topical" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="subject_topical" />
          </sv:property>

          <sv:property sv:name="ns004:subject_topical_uri" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="subject_topical_uri" />
          </sv:property>

          <sv:property sv:name="ns004:subject_geographic" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="subject_geographic" />
          </sv:property>

          <sv:property sv:name="ns004:subject_geographic_uri" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="subject_geographic_uri" />
          </sv:property>

          <sv:property sv:name="ns004:subject_genre_form" sv:type="String" sv:multiple="false">
            <xsl:apply-templates select="subject_genre_form" />
          </sv:property>

          <sv:property sv:name="ns004:subject_genre_form_uri" sv:type="String" sv:multiple="false">
